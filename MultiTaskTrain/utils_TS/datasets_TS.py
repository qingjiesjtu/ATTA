...
from utils_TS.augmentations_TS import horisontal_flip
...
class ImageFolder(Dataset):  # not being used (yzn)
    ...
    def __getitem__(self, index):
        ...
        # Resize
        img = resize_TS(img, self.img_size)
...
class ListDataset(Dataset):
    ...
    def collate_fn(self, batch):
        ...
        imgs = torch.stack([resize_TS(img, self.img_size) for img in imgs])
        self.batch_count += 1
